...
void AstDump::visitFuncDef(FuncDef* node) { VISIT_FIELD(block); }
...
void AstDump::visitBlock(Block* node) { VISIT_VEC_FIELD(stmts); }
...
void AstDump::visitReturnStmt(ReturnStmt* node) { VISIT_FIELD(retval); }

void AstDump::visitSimpleStmt(SimpleStmt* node) { VISIT_FIELD(expr); }
...
void AstDump::visitStmt(Stmt* node) { panic("should not reach here"); }

void AstDump::visitClosureExpr(ClosureExpr* node) { VISIT_FIELD(block); }
...
void AstDump::visitIndexExpr(IndexExpr* node) { VISIT_FIELD(index) }

void AstDump::visitIdentExpr(IdentExpr* node) {
    // Pass
}

void AstDump::visitArrayExpr(ArrayExpr* node) { VISIT_VEC_FIELD(literal); }
...
void AstDump::visitExportStmt(ExportStmt* node) { VISIT_VEC_FIELD(exports); }

void AstDump::visitImportStmt(ImportStmt* node) { VISIT_VEC_FIELD(imports); }
